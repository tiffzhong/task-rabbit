          ...
          <div className="question-box">
            <div className="inner-container">
              ...
              <input
                ...
                onChange={e => this.props.updateLocationStart(e.target.value)}
              />
          ...
          {this.state.locationToggle ? (
            <div className="question-box">
              <div className="inner-container">
                ...
                <input
                  placeholder="An estimated time of how long your task should take to be completed"
                  onChange={e => this.props.updateDuration(e.target.value)}
                />
                <div className="form-button">
                  <button
                    onClick={() =>
          ...
          {this.state.durationToggle ? (
            <div className="question-box">
              <div className="inner-container">
                ...
                <input
                  placeholder="Is a vehicle needed for this task? If yes, please specify a car or truck"
                  onChange={e => this.props.updateVehicle(e.target.value)}
                />
                <div className="form-button">
                  <button
                    onClick={() =>
