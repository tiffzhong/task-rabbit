...
class ClientEdit extends Component {
  ...
  render() {
    console.log("form", this.state.formType);
    return (
      <div className="form">
        Client Edit
        {this.state.formType === "moving" ||
        this.state.formType === "yardwork" ? (
        ...
        ) : this.state.formType === "furniture" ||
          this.state.formType === "home" ||
          this.state.formType === "cleaning" ||
          this.state.formType === "pet" ||
          this.state.formType === "cooking" ? (
          <div className="outer-container">
            <LocationSingle />
            <Duration />
            <Schedule />
